    ...
    <>
      <section className="relative overflow-hidden bg-navy-gradient pt-40 pb-24 md:pt-48 md:pb-28">
        ...
        <div className="container-max relative px-6 md:px-12 lg:px-20">
          <Reveal>
            <p className="eyebrow mb-5">Vaka Çalışması · {cs.industry}</p>
          </Reveal>
          <Reveal delay={0.05}>
            <h1 className="font-display text-balance max-w-4xl text-3xl md:text-5xl leading-[1.12] tracking-tight text-white">
              {cs.title}
            </h1>
          </Reveal>
          <Reveal delay={0.1}>
            ...
            <Reveal key={s.key} delay={i * 0.07}>
              <div className="card-premium h-full">
                <div className="flex items-center gap-3">
                  <s.icon size={20} className="text-gold-500" strokeWidth={1.5} />
      ...
      <section className="section-pad bg-navy-gradient relative overflow-hidden">
        ...
        <div className="container-max relative grid grid-cols-1 md:grid-cols-2 gap-6">
          <Reveal>
            <div className="glass-panel rounded-sm p-10 h-full">
              <LineChart size={26} className="text-gold-500" strokeWidth={1.5} />
        ...
        <div className="container-max">
          <Reveal>
            <div className="mx-auto max-w-3xl text-center">
              <Lightbulb size={28} className="text-gold-500 mx-auto" strokeWidth={1.5} />
              <p className="eyebrow mt-5 mb-4">Çıkarılan Ders</p>
              <p className="font-display text-balance text-2xl md:text-4xl leading-[1.3] text-white">
